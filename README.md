...
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Shaik Mohammad Abraar (Team Leader)** | Project planning, application architecture, Firebase integration, JSON implementation, splash screen,Authentication module, notifications, final integration, bug fixing, APK generation,demo video, deployment, and project coordination. |
